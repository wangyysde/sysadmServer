...
// LoggerWriter is the logger instance used by sysadmServer for debug output and 
...
var LoggerWriter sysadmLogger.SysadmLogWriter = nil
...
func init() {                                                                                                                                                                                                                            
    mode := os.Getenv(sysadmServerMode)                                                                                                                                                                                                
    SetMode(mode)                                                                                                                                                                                                                        
}                                                                                                                                                                                                                                       
...
func (e *Engine) debugPrintWARNINGNew() {                                                                                                                                                                                              
    if IsDebugging() {                                                                                                                                                                                                                   
        e.logWriter.ErrorWriter("debug", `Running in "debug" mode. Switch to "release" mode in production.                                                                                                             
