...
func main() {
	...
	authorized := router.Group("/", sysadmServer.BasicAuth(sysadmServer.Accounts{
		"admin": "admin123", // username : admin, password : admin123
	}))

	// Authorized client can stream the event
	authorized.GET("/stream", func(c *sysadmServer.Context) {
...
func (stream *Event) serveHTTP() sysadmServer.HandlerFunc {
...
func HeadersMiddleware() sysadmServer.HandlerFunc {
	return func(c *sysadmServer.Context) {
